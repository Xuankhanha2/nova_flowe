        ...
        public virtual ServiceResult insert<entity>(entity param)
        {
            try
            {
                ...
                if (serviceResult.isValid)
                {
                    ...
                    {
                        serviceResult.code = statusCode.success;
                        serviceResult.message = Constants.CREATED_SUCCESS;
                        serviceResult.data = string.Empty;
                    }
                    else
                    {
                        serviceResult.code = statusCode.fail;
                        serviceResult.message = Constants.CREATED_FAIL;
                        serviceResult.data = string.Empty;
                    }
                }
                else
        ...
        public ServiceResult update<entity>(entity param)
        {
            try
            {
                ...
                if (serviceResult.isValid)
                {
                    ...
                    {
                        serviceResult.code = statusCode.success;
                        serviceResult.message = Constants.UPDATE_SUCCESS;
                        serviceResult.data = check;
                    }
                    else
                    {
                        serviceResult.code = statusCode.fail;
                        serviceResult.message = Constants.UPDATE_FAIL;
                        serviceResult.data = check;
                    }
                }
                else
        ...
        public ServiceResult delete<entity>(Guid id)
        {
            try
            {
                if (id != null)
                {
                    ...
                    {
                        serviceResult.code = statusCode.success;
                        serviceResult.message = Constants.DELETE_SUCCESS;
                        serviceResult.data = check;
                    }
                    else
                    {
                        serviceResult.code = statusCode.fail;
                        serviceResult.message = Constants.DELETE_FAIL;
                        serviceResult.data = string.Empty;
                    }
                }
            }
            ...
            foreach(var property in properties)
            {
                ...
                if (property.IsDefined(typeof(Required), false))
                {
                    ...
                    if(propertyValue == null || propertyValue.ToString().Equals(""))
                    {
                        ...
                        serviceResult.code = statusCode.notValid;
                        serviceResult.message = string.Format(Common.Validations.REQUIRED_DATA, property.Name);
                    }
                }
